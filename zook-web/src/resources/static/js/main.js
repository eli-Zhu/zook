...
head.js(__ctx + "/js/skin-select/jquery.cookie.js");
head.js(__ctx + "/js/skin-select/skin-select.js");
...
head.js(__ctx + "/js/custom/scriptbreaker-multiple-accordion-1.js", function() {
...
head.js(__ctx + "/js/slidebars/slidebars.min.js", __ctx + "/js/jquery.easing.min.js", function() {
...
//SEARCH MENU
head.js(__ctx + "/js/search/jquery.quicksearch.js", function() {
...
head.js(__ctx + "/js/tip/jquery.tooltipster.js", function() {
...
head.js(__ctx + "/js/nano/jquery.nanoscroller.js", function() {
...
//------------------------------------------------------------- 
//PAGE LOADER
head.js(__ctx + "/js/pace/pace.js", function() {
